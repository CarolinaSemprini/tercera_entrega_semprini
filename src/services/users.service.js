...
class UserService {
  ...
  async registerUser(first_name, last_name, age, email, password, role) {
    try {
      ...
      const userCreated = await usersModel.create(first_name, last_name, age, email, hashedPassword, role, cartID);
